                ...
                <div>
                    ...
                    <div className="grid grid-cols-10 gap-1 mt-5 mb-5 ">
                        {tarotDeck.filter(t => flippedCards.includes(t.name)).map((card, index) => (
                            <div>
                                <Image src={`/decks/rws/${flippedCards.includes(card.name) ? card.img : 'back.jpg'}`}
                    ...
                    <div className="flex items-start mt-2 flex-col md:flex-row">
                        <div className="text-sm text-gray-500 pr-5">
                            Aşağıdan en az 3 adet tarot kartı seçiniz. Kartları seçerken hissederek seçmeyi unutmayın.
                    ...
                    <span className="ml-auto my-2 text-gray-500 text-xs hidden md:block">Powered By. <a href="https://www.ardagunsuren.com">Arda GÜNSÜREN</a></span>
